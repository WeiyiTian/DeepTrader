...
folder_path = "./data/HS300/market"  # Ensure this is correct
output_folder = "./data/HS300/market"
...
train_output_folder = "./data/HS300/market"
test_output_folder = "./data/HS300/market"
save_dir = "./data/HS300/HS300DS"  # Ensure this directory exists
npy_train_path = os.path.join(save_dir, "market_train_data.npy")
npy_test_path = os.path.join(save_dir, "market_test_data.npy")
